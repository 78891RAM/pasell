    ...
    return Scaffold(
      ...
      child: SingleChildScrollView(
        child: Container(
          ...
          decoration:
              const BoxDecoration(color: Color.fromARGB(255, 168, 18, 18)),
          child: Column(
            children: [
              SizedBox(
                height: 450,
              ...
              const Text(
                  "This pasell App si about selling your old stuffs to new people.\n\n",
                  style: TextStyle(
                      letterSpacing: 0.5,
                      fontSize: 17,
                      decoration: TextDecoration.none,
                ...
                children: [
                  ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromARGB(255, 25, 233, 25),
                  ...
                  ElevatedButton(
                      style: ElevatedButton.styleFrom(
                          backgroundColor:
                              const Color.fromARGB(255, 189, 154, 108),
                          shape: const StadiumBorder(),
                          minimumSize: const Size(100, 40)),
                      onPressed: () {
                        Navigator.push(
